...
export const POST = async (req) => {
  try {
    ...
    const mailOptions = {
      from: email,
      to: email,
      subject: `Contact Form Response from ${data.name}`,
    ...
    console.error('Error parsing data or sending email:', err);
